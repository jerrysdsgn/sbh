...
var verifMsg = document.getElementById("verificationMsg");
...
function checkEmail(){
    ...
    if(emailInput.value.match(mailformat) && slice == ".com"){
        varifNot.innerHTML = "<span class='notification learnion-green-bg'><strong>"+emailInput.value+"</strong> submitted to mailing list</span>";
